...
QT_MOC_LITERAL(1, 10, 8), // "SendType"
QT_MOC_LITERAL(2, 19, 0), // ""
QT_MOC_LITERAL(3, 20, 13), // "AlgorithmType"
QT_MOC_LITERAL(4, 34, 9) // "OnClicked"

    },
    "Thumbnail\0SendType\0\0AlgorithmType\0"
    "OnClicked"
};
...
void Thumbnail::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->SendType((*reinterpret_cast< AlgorithmType(*)>(_a[1]))); break;
        ...
        {
            typedef void (Thumbnail::*_t)(AlgorithmType );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Thumbnail::SendType)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject Thumbnail::staticMetaObject = {
    { &QToolButton::staticMetaObject, qt_meta_stringdata_Thumbnail.data,
...
// SIGNAL 0
void Thumbnail::SendType(AlgorithmType _t1)
{
